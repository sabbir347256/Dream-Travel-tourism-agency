...
const Discount = () => {
    return (
        <div className="flex flex-col md:flex-col lg:flex-row libre-font mt-20 max-w-6xl mx-auto mr-7">
            <div className="w-3/5">
                <h2 className="text-4xl text-center font-extrabold mb-10 mt-20  w-[350px] md:w-full lg:w-full left-5 md:left-0 lg:left-0 relative">90,100 Marker In 120+ Countries.</h2>
