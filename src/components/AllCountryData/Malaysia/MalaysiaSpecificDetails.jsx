...
const MalaysiaSpecificDetails = () => {
    const malSpotDetails = useLoaderData();
    const { id } = useParams();
    const detailsData = malSpotDetails.find(data => data.id == id);
...
export default MalaysiaSpecificDetails;