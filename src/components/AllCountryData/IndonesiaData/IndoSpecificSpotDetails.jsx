...
const IndoSpecificSpotDetails = () => {
    const indoSpotDetails = useLoaderData();
    const {id} = useParams();
    const  indoData = indoSpotDetails.find(data => data.id == id);
    const { averageCost, countryName, image, location, perYearVisitor, seasonality, shortDescription, spotName, travelTime } = indoData;
    return (
...
export default IndoSpecificSpotDetails;